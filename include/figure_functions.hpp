...
#ifndef KNIGHT_HPP
#define KNIGHT_HPP
extern void knight(char board[8][8], figure_coordinates figures[4], string move, bool *moved);
#endif

#ifndef ROOK_HPP
#define ROOK_HPP
extern void rook(char board[8][8], figure_coordinates figures[4], string move, bool *moved);
#endif
